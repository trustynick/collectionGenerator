//___________________________________________________Line_Bezier_Polygon _____________________________________________________________
function feat9(_a) {
...
this.size = random(sizeMin, sizeMax);
  //var this.size = random(xSpacer / 10, xSpacer / 5);
